...
``vercel.workflow._internal.devalue`` exists to speak the same wire format as the JS
...
from vercel.workflow._internal.devalue import Hole, JsBigInt, JsRegExp, Undefined, parse, stringify
from vercel.workflow._internal.devalue.constants import (
    HOLE,
    NAN,
    NEGATIVE_INFINITY,
    NEGATIVE_ZERO,
...
from vercel.workflow._internal.devalue.parse import _BYTES_PER_ELEMENT
