...
def _service() -> SchedulesService:
    return get_schedules_service(get_active_session())
...
async def get_schedule(name: str, *, namespace: str | None = None) -> Schedule:
    ...
    """
    return await _get_schedule(_service(), name, namespace=namespace)
...
async def delete_schedule(name: str, *, namespace: str | None = None) -> None:
    """Delete a schedule. Pending firings are dropped.

    Raises:
        ScheduleNotFoundError: If no schedule has this name in the namespace.
    """
    await _delete_schedule(_service(), name, namespace=namespace)


async def enable_schedule(name: str, *, namespace: str | None = None) -> Schedule:
    ...
    Raises:
        ScheduleNotFoundError: If no schedule has this name in the namespace.
    """
    return await _enable_schedule(_service(), name, namespace=namespace)


async def disable_schedule(name: str, *, namespace: str | None = None) -> Schedule:
    ...
    Raises:
        ScheduleNotFoundError: If no schedule has this name in the namespace.
    """
    return await _disable_schedule(_service(), name, namespace=namespace)


async def invoke_schedule(name: str, *, namespace: str | None = None) -> None:
    ...
    Raises:
        ScheduleNotFoundError: If no schedule has this name in the namespace.
    """
    await _invoke_schedule(_service(), name, namespace=namespace)
