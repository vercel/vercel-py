...
async def get_schedule(schedule_id: str) -> Schedule:
    ...
    """
    return await _get_schedule(_service(), schedule_id)
...
async def delete_schedule(schedule_id: str) -> None:
    ...
    Raises:
        ScheduleNotFoundError: If no schedule has this id.
    """
    await _delete_schedule(_service(), schedule_id)


async def enable_schedule(schedule_id: str) -> Schedule:
    ...
    Raises:
        ScheduleNotFoundError: If no schedule has this id.
    """
    return await _enable_schedule(_service(), schedule_id)


async def disable_schedule(schedule_id: str) -> Schedule:
    ...
    Raises:
        ScheduleNotFoundError: If no schedule has this id.
    """
    return await _disable_schedule(_service(), schedule_id)
